...
const long pnlSi5351::ID_STATICTEXT14 = wxNewId();
const long pnlSi5351::ID_BUTTON1 = wxNewId();
const long pnlSi5351::ID_BUTTON5 = wxNewId();
...
void pnlSi5351::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
    ...
    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pnlSi5351::OnbtnReadStatusClick);
    Connect(ID_BUTTON5,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pnlSi5351::OnbtnClearStatusClick);
...
void pnlSi5351::ModifyClocksGUI(eLMS_DEV board)
{
    for(int i=0; i<8; ++i)
        ClockEnable(i, true);
...
void pnlSi5351::ClockEnable(unsigned int i, bool enabled)
{
    switch(i)
    {
    case 0:
...
void pnlSi5351::OnbtnReadStatusClick(wxCommandEvent& event)
{
    Si5351C::Status stat = m_pModule->GetStatus();
...
void pnlSi5351::OnbtnClearStatusClick(wxCommandEvent& event)
{
