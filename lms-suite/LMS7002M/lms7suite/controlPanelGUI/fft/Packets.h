...
@brief	Packets used for data transmitting between modules
*/
#ifndef PACKETS_h
#define PACKETS_h
...
public:
    FFTPacket() : samplesCount(32768), channel(0)
	{
	    ...
	    amplitudes_dbFS = new float[amplitudesCount];
	}
	...
	FFTPacket& operator=(FFTPacket& obj)
	{
		...
		memcpy(this->amplitudes_dbFS, obj.amplitudes_dbFS, sizeof(float)*amplitudesCount);
		this->channel = obj.channel;
		return *this;
	}
	const int samplesCount;
