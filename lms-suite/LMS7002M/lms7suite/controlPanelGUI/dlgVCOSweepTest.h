/**
@file 	dlgVCOSweepTest.h
@author Lime Microsystems
*/

#ifndef dlgVCOSweepTest_H
#define dlgVCOSweepTest_H

//(*Headers(dlgVCOSweepTest)
#include <wx/dialog.h>
class wxGauge;
class wxCheckBox;
class wxTextCtrl;
...
class dlgVCOSweepTest: public wxDialog, public GUIPanel
{
	public:

		dlgVCOSweepTest(wxWindow* parent,wxWindowID id=wxID_ANY,const wxPoint& pos=wxDefaultPosition,const wxSize& size=wxDefaultSize);
		virtual ~dlgVCOSweepTest();
		void Initialize(LMS7002_MainControl *pControl, bool Rx);
		void UpdateGUI();
        void AddParameters();
        void Sweep();
		//(*Declarations(dlgVCOSweepTest)
